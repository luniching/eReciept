...
//            public/js/main.js.
//
// webcore.extendDust(['path/to/my-dust-extension']);
...
server.configure(function() {
	...
	/**
	 * Session Support - http://expressjs.com/guide.html#session-support
	 * To enable session support in your application uncomment the following line.
	 * The out-of-the-box session middleware IS NOT RECOMMENDED FOR PRODUCTION USE
	 * and additional configuration is required. Usually that's configuring and
	 * setting and alternate session store. Additionally, the session middleware
	 * has a dependency on cookieParser middleware and must come AFTER cookieParser
